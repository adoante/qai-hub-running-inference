...
thread1 = threading.Thread(target=lambda: [inference_dataset(file, model_id, device_name, model_name) for file in list1])
thread2 = threading.Thread(target=lambda: [inference_dataset(file, model_id, device_name, model_name) for file in list2])
